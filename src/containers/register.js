        ...
        <div class="auth-form">
            <div class="row">
                ...
                <h2 class="center-align form-header">Create User</h2>
                    ...
                    <a class="submit-btn waves-effect waves-light blue btn-large"><i class="material-icons left">send</i>Create User</a>
                    <a class="center-align" href="#" onclick='rootRender(login())'>
